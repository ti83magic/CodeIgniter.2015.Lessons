...
class Template {
    ...
    public function call($content = '', $data) {       
        $partials = array('header' => 'main_header', 'menu' => 'main_menu', 'content' => $content, 'footer' => 'main_footer');
        $this->load('main_master', $partials, $data);
    }
